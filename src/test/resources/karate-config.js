function fn() {
    ...
    const urlDev = 'jdbc:mysql://localhost:3306/projetiav6';
    ...
    config.familleExigenceUrl = config.adminUri + 'familleExigence/';
    config.dossierProjetExigenceUrl = config.adminUri + 'dossierProjetExigence/';
    config.dossierProjetUrl = config.adminUri + 'dossierProjet/';
    config.dossierProjetExigenceAppliqueUrl = config.adminUri + 'dossierProjetExigenceApplique/';
    config.dossierProjetExigenceEtatUrl = config.adminUri + 'dossierProjetExigenceEtat/';
    config.exigenceUrl = config.adminUri + 'exigence/';
    config.dossierProjetDocumentUrl = config.adminUri + 'dossierProjetDocument/';
